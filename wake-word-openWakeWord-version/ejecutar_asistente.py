#!/usr/bin/env python3
"""
🎤 EJECUTOR RÁPIDO - Asistente de Voz Puertocho con openWakeWord
...
def run_foreground():
    ...
    print("🧠 Motor: openWakeWord (sin API keys)")
    print("\n💡 Para detener: Ctrl+C")
    print("="*60)
...
def show_help():
    """Mostrar ayuda"""
    print_header("AYUDA - ASISTENTE DE VOZ PUERTOCHO CON OPENWAKEWORD")
    ...
    print()
    print("🎤 WAKE WORDS (openWakeWord):")
    print("   • 'Alexa' (modelo alexa)")
    print("   • 'Hey Mycroft' (modelo hey_mycroft)")
    print("   💡 Puedes entrenar modelos personalizados como 'Puertocho'")
    print()
    print("🔧 COMANDOS DE VOZ:")
    print("   • 'enciende luz verde' / 'enciende led verde'")
    print("   • 'apaga luz verde' / 'apaga led verde'")
    print("   • 'enciende luz rojo' / 'enciende led rojo'")
    print("   • 'apaga luz rojo' / 'apaga led rojo'")
    print()
    print("💡 TIPS:")
    print("   • LED Verde: Listo para escuchar")
    print("   • LED Rojo: Grabando comando")
    print("   • Botón GPIO 22: Activación manual")
    print("   • Sin API keys necesarias (funciona offline)")
    print()
    print("🔧 CONFIGURACIÓN:")
    print("   • Modelos: Configura OPENWAKEWORD_MODEL_PATHS en .env")
    print("   • Umbral: Ajusta OPENWAKEWORD_THRESHOLD en .env")
    print("   • VAD: Habilita OPENWAKEWORD_VAD_THRESHOLD en .env")
...
def diagnose_system():
    ...
    print("\n3️⃣ VERIFICANDO OPENWAKEWORD...")
    try:
        result = subprocess.run([
            "python3", "-c", 
            "import openwakeword; print(f'✅ openWakeWord v{openwakeword.__version__} instalado')"
        ], capture_output=True, text=True)
        if result.returncode == 0:
        ...
        print("❌ Error verificando openWakeWord")
    
    print("\n4️⃣ VERIFICANDO CONTENEDORES...")
    try:
        result = subprocess.run(["docker", "ps", "-a", "--filter", "name=puertocho"], 
                              capture_output=True, text=True)
    ...
    print("   • Instalar openWakeWord: pip install openwakeword")
    
    print("\n💡 Configuración openWakeWord:")
    print("   • Modelos disponibles: alexa, hey_mycroft, hey_jarvis, timers, weather")
    print("   • Configura modelos en .env: OPENWAKEWORD_MODEL_PATHS=alexa,hey_mycroft")
    print("   • Ajusta umbral en .env: OPENWAKEWORD_THRESHOLD=0.5")
